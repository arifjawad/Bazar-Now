...
if(isset($_POST["email"]) && isset($_POST["password"])){
	...
	$sql = "SELECT * FROM delivery_person WHERE delivery_person_email = '$email' AND delivery_person_password = '$password'";
	$run_query = mysqli_query($con,$sql);
	$count = mysqli_num_rows($run_query);
    $row = mysqli_fetch_array($run_query);
		$_SESSION["uid"] = $row["delivery_person_id"];
		$_SESSION["name"] = $row["delivery_person_name"];
