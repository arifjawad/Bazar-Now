...
<body>
  <?php include("include/header.php");?>
	...
	<h1>Products list / Brands <?php echo $page;?> </h1></div><br>
...
$result=mysqli_query($con,"select product_id,product_image, product_title,product_price from products  where  product_cat=2 or product_cat=3 or product_cat=4 Limit $page1,5")or die ("query 1 incorrect.....");
